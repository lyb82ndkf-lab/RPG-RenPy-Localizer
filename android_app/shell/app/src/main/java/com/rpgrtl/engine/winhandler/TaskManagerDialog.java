...
import com.rpgrtl.engine.contentdialog.ContentDialog;
import com.rpgrtl.engine.core.BatteryUtils;
import com.rpgrtl.engine.core.CPUStatus;
import com.rpgrtl.engine.core.ProcessHelper;
import com.rpgrtl.engine.core.StringUtils;
import com.rpgrtl.engine.core.UnitUtils;
import com.rpgrtl.engine.widget.CPUListView;
...
public class TaskManagerDialog extends ContentDialog implements OnGetProcessInfoListener {
    ...
    private void updateCPUPanel() {
        ...
        cpuPanel.setTextAt(1, CPUStatus.getTemperature()+"潞C");
    ...
    private void updateBatteryPanel() {
        ...
        batteryPanel.setTextAt(1, batteryInfo.temperature+"潞C");
