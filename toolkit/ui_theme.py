...
def configure_app_style(
    ...
    *,
    ...
    compact_font = ("Microsoft YaHei UI", 8)
    style.configure(".", font=button_font)
    style.configure("TButton", padding=(5, 1), font=button_font)
    style.configure("Primary.TButton", padding=(5, 1), font=button_font)
    style.configure("Tool.TButton", padding=(4, 0), font=compact_font)
    ...
    style.configure("Treeview", rowheight=22, font=button_font)
